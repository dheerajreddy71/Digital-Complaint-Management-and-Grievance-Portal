...
import { Feedback, CreateFeedbackDto, FeedbackResponse, StaffPerformanceMetrics } from '../models';
...
export class FeedbackRepository {
  ...
  async findByComplaintId(complaintId: number): Promise<FeedbackResponse | null> {
    const rows = await query<RowDataPacket[]>(
      `SELECT f.*, c.title as complaint_title, c.user_id, c.staff_id,
