...
export class ComplaintRepository {
	...
	async findAll(
		...
		if (filters.staff_id && filters.staff_id !== "") {
		...
		// Get paginated results - ensure all params are properly typed
		const queryParams = [...cleanParams, limitNum, offsetNum];
		...
		console.log('Param types:', queryParams.map((p, i) => `[${i}] ${typeof p} = ${p}`));
		console.log('=======================');
