...
const seedComplaints = [
	{
		...
		description:
			"There is water dripping from the ceiling in my room. It started after last night's rain.",
		category: "Plumbing",
		priority: "High",
	...
	},
	{
		...
		description:
			"The power outlet near my desk stopped working yesterday. I cannot charge my laptop.",
		category: "Electrical",
		priority: "Medium",
		location: "Room 201, Building A",
		status: "Assigned",
	...
	},
	{
		...
		description:
			"The air conditioner is running but not cooling the room. Temperature stays at 30°C.",
		category: "Facility",
		priority: "High",
	...
	},
	{
		...
		description:
			"Internet is very slow and keeps disconnecting every few minutes.",
		category: "IT",
		priority: "Medium",
	...
	},
	{
		...
		description:
			"The door handle to my room is loose and might fall off. Needs urgent repair.",
		category: "Facility",
		priority: "Low",
		location: "Room 201, Building A",
		status: "Open",
	...
	try {
		...
		for (const complaint of seedComplaints) {
			...
			slaDeadline.setHours(
				slaDeadline.getHours() + SLA_HOURS[complaint.priority]
			);
