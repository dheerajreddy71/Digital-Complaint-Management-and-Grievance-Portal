  ...
  template: `
    <div class="page-container">
      <div class="page-header fade-in">
        ...
        <p class="subtitle">Track your resolution statistics and performance metrics</p>
      </div>
      ...
      <ng-container *ngIf="!isLoading && performance">
        ...
        <div class="stats-grid fade-in">
          ...
          <mat-card class="stat-card">
            ...
            <div class="stat-content">
              <span class="stat-value">{{ formatDuration(performance.avg_resolution_time) }}</span>
          ...
          <mat-card class="stat-card">
            ...
            <div class="stat-content">
              <span class="stat-value">{{ performance.avg_rating | number:'1.1-1' }}</span>
              ...
              <div class="feedback-item" *ngFor="let fb of recentFeedback">
                <div class="feedback-header">
                  <app-star-rating
                    ...
                    size="small"
                  ></app-star-rating>
                  <span class="feedback-date">{{ fb.created_at | timeAgo }}</span>
                </div>
                <p class="feedback-comment" *ngIf="fb.comments">"{{ fb.comments }}"</p>
