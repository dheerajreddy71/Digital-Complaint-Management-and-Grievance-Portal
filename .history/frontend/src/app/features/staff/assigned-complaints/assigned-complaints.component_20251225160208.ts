		...
		<div class="page-container">
			<div class="page-header fade-in">
				<div class="header-left">
					...
					<p class="subtitle">Complaints assigned to you for resolution</p>
				</div>
...
export class AssignedComplaintsComponent implements OnInit {
	...
	loadActiveComplaints(): void {
		...
		// My Active Work: Only show complaints ASSIGNED to me (Assigned or In Progress status)
		// Note: "Open" status means unassigned, so exclude it
			...
			if (confirmed) {
				this.complaintService
					...
					.subscribe({
						...
						error: (err) => {
							const errorMsg =
								err.error?.error || "Failed to update complaint status";
