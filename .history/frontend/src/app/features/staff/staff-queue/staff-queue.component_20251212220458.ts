  ...
  template: `
    <div class="page-container">
      <div class="page-header fade-in">
        ...
        <p class="subtitle">Unassigned complaints waiting to be picked up</p>
      </div>
      ...
      <mat-card class="filters-card fade-in">
        <div class="filters-row">
          <mat-form-field appearance="outline" class="filter-field">
            ...
            <mat-select [(ngModel)]="priorityFilter" (selectionChange)="loadQueue()">
          ...
          <mat-form-field appearance="outline" class="filter-field">
            ...
            <mat-select [(ngModel)]="categoryFilter" (selectionChange)="loadQueue()">
      ...
      <div class="queue-list" *ngIf="!isLoading">
        <app-empty-state
          *ngIf="complaints.length === 0"
          ...
          message="No unassigned complaints match your filters"
        ></app-empty-state>
        ...
        >
          <div class="queue-item-main" (click)="viewComplaint(complaint)">
            <div class="queue-item-header">
              <div class="badges">
                ...
                <span class="category-chip">{{ complaint.category | categoryLabel }}</span>
              </div>
              <app-sla-indicator
          ...
          <div class="queue-item-actions">
            ...
            >
              <mat-spinner *ngIf="isPickingUp === complaint.id" diameter="18"></mat-spinner>
              <mat-icon *ngIf="isPickingUp !== complaint.id">assignment_ind</mat-icon>
              <span>Pick Up</span>
            </button>
          </div>
        </mat-card>
