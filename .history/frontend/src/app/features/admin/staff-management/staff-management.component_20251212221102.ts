...
import { User, StaffPerformance } from '@core/models';
    ...
    <div class="page-container">
      ...
      <div class="summary-cards fade-in">
        ...
        <mat-card class="summary-card">
          ...
          <div class="summary-content">
            <span class="summary-value">{{ avgTeamRating | number:'1.1-1' }}</span>
        ...
        <div class="table-container">
          <table mat-table [dataSource]="dataSource" matSort>
            <ng-container matColumnDef="name">
              ...
              <td mat-cell *matCellDef="let staff">
                <div class="staff-cell">
                  <div class="staff-avatar" [class.available]="staff.is_available">
                    {{ staff.name.charAt(0).toUpperCase() }}
                  </div>
                  <div class="staff-info">
                    <span class="staff-name">{{ staff.name }}</span>
                    <span class="availability-badge" [class.available]="staff.is_available">
            ...
            <ng-container matColumnDef="current_load">
              <th mat-header-cell *matHeaderCellDef mat-sort-header>Current Load</th>
              <td mat-cell *matCellDef="let staff">
            ...
            <ng-container matColumnDef="resolved_count">
              <th mat-header-cell *matHeaderCellDef mat-sort-header>Total Resolved</th>
              <td mat-cell *matCellDef="let staff">
            ...
            <ng-container matColumnDef="avg_resolution_time">
              <th mat-header-cell *matHeaderCellDef mat-sort-header>Avg Resolution Time</th>
              <td mat-cell *matCellDef="let staff">
              ...
              <td mat-cell *matCellDef="let staff">
                <div class="rating-cell">
                  <app-star-rating
                    ...
                    size="small"
                  ></app-star-rating>
                  <span class="rating-value">{{ staff.avg_rating | number:'1.1-1' }}</span>
                </div>
              </td>
            </ng-container>
            ...
            <ng-container matColumnDef="actions">
              ...
              <td mat-cell *matCellDef="let staff">
                ...
                >
                  <mat-icon>{{ staff.is_available ? 'toggle_on' : 'toggle_off' }}</mat-icon>
                </button>
                <button mat-icon-button matTooltip="View Details" (click)="viewDetails(staff)">
        ...
        <mat-dialog-content>
          <div class="detail-grid">
            ...
            <div class="detail-item">
              ...
              <span class="detail-value">{{ staff.created_at | date:'mediumDate' }}</span>
            </div>
            <div class="detail-item">
              <span class="detail-label">Current Load</span>
              <span class="detail-value">{{ staff.current_load }} complaints</span>
            </div>
            <div class="detail-item">
            ...
            <div class="detail-item">
              ...
              <span class="detail-value">{{ formatDuration(staff.avg_resolution_time) }}</span>
            </div>
            <div class="detail-item full-width">
              <span class="detail-label">Rating</span>
              <div class="rating-display">
                <app-star-rating [rating]="staff.avg_rating" [readonly]="true"></app-star-rating>
...
export class StaffManagementComponent implements OnInit {
  ...
  private calculateSummary(): void {
    ...
    this.availableStaff = this.staffList.filter((s) => s.is_available).length;
    this.busyStaff = this.staffList.filter((s) => s.current_load > 10).length;

    const ratings = this.staffList.filter((s) => s.avg_rating > 0).map((s) => s.avg_rating);
    this.avgTeamRating = ratings.length > 0
  ...
  toggleAvailability(staff: StaffPerformance & User): void {
    const newAvailability = !staff.is_available;

    this.userService.updateAvailability(newAvailability, staff.id).subscribe({
      next: () => {
        staff.is_available = newAvailability;
        this.calculateSummary();
        this.snackbar.success(
          `${staff.name} is now ${newAvailability ? 'available' : 'unavailable'}`
        );
      },
    });
  }
