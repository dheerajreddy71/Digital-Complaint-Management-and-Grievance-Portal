      ...
      <ng-container *ngIf="!isLoading && analytics">
        ...
        <div class="metrics-grid fade-in">
          ...
          <mat-card class="metric-card">
            ...
            <div class="metric-content">
              <span class="metric-value">{{ analytics.status_breakdown.pending || 0 }}</span>
          ...
          <mat-card class="metric-card">
            ...
            <div class="metric-content">
              <span class="metric-value">{{ analytics.status_breakdown.in_progress || 0 }}</span>
          ...
          <mat-card class="metric-card">
            ...
            <div class="metric-content">
              <span class="metric-value">{{ analytics.status_breakdown.resolved || 0 }}</span>
              ...
              <div class="status-chart">
                <div
                  ...
                  *ngFor="let status of statusData"
                  [style.width.%]="(status.count / analytics.total_complaints) * 100"
        ...
        <mat-card class="staff-card fade-in">
          ...
          <mat-card-content>
            <div class="table-container">
              <table mat-table [dataSource]="analytics.staff_performance" class="staff-table">
                ...
                <ng-container matColumnDef="resolved">
                  ...
                  <td mat-cell *matCellDef="let staff">{{ staff.resolved_count }}</td>
                </ng-container>
                ...
                <ng-container matColumnDef="load">
                  ...
                  <td mat-cell *matCellDef="let staff">
                    <span
                      ...
                      [class.medium]="staff.current_load > 5 && staff.current_load <= 10"
                    >
                      {{ staff.current_load }}
                    </span>
                  </td>
        ...
        <!-- Recent Overdue -->
        <mat-card class="overdue-card fade-in" *ngIf="overdueComplaints.length > 0">
          <mat-card-header>
