          ...
          >
            <mat-form-field appearance="outline" class="full-width">
              ...
              <textarea
                ...
                maxlength="1000"
              ></textarea>
              <mat-hint align="end">{{ commentForm.get('comment')?.value?.length || 0 }}/1000</mat-hint>
            </mat-form-field>
            <div class="form-actions">
              <mat-checkbox formControlName="is_internal" *ngIf="isStaffOrAdmin">
          ...
          <div class="comments-list">
            ...
            >
              <div class="comment-avatar">
                <mat-icon>{{ comment.is_internal ? 'lock' : 'person' }}</mat-icon>
              </div>
              <div class="comment-content">
                <div class="comment-header">
                  <div class="comment-meta">
                    <span class="author">{{ comment.user_name }}</span>
                    <span class="role-badge" [class]="'role-' + comment.user_role">
                  ...
                  <span class="timestamp">{{ comment.created_at | timeAgo }}</span>
                </div>
