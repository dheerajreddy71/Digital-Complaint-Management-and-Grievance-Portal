    ...
    <mat-card class="timeline-card">
      ...
      <mat-card-content>
        ...
        <div class="timeline" *ngIf="!isLoading">
          ...
          <div class="timeline-item" *ngFor="let item of history; let first = first">
            ...
            <div class="timeline-content">
              <div class="timeline-header">
                <span class="status-change">
                  ...
                  <span class="new-status" [class]="'status-' + item.new_status">
                    {{ item.new_status | titlecase }}
                  </span>
                </span>
                <span class="timestamp">{{ item.changed_at | timeAgo }}</span>
              </div>
