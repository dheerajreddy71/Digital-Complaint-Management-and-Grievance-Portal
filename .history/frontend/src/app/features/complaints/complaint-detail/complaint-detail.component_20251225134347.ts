						...
						<mat-card class="sidebar-card fade-in">
							...
							<mat-card-content>
								<div
									...
									*ngIf="complaint.assigned_staff_name"
								>
									...
									<div class="staff-info">
										...
										<div
											...
											*ngIf="complaint.assigned_staff_department"
										>
								...
								<div
									class="assignment-status unassigned"
									*ngIf="!complaint.assigned_staff_name"
								>
								...
								<div class="info-row">
									...
									<span class="value" [class.overdue]="complaint.is_overdue">
										...
										<mat-icon class="overdue-icon" *ngIf="complaint.is_overdue"
											>warning</mat-icon
										>
									</span>
								</div>
