...
import { Complaint, ComplaintFilters, PaginatedResponse, ComplaintStatus, Priority, ComplaintCategory } from '@core/models';
    ...
    <div class="page-container fade-in">
      <div class="page-header">
        ...
        <button
          ...
          *ngIf="authService.currentUser?.role === 'user'"
        >
      ...
      <app-complaint-filters
        [filters]="filters"
        [showUserFilter]="authService.currentUser?.role !== 'user'"
        ...
        <div class="complaints-grid" *ngIf="complaints.length > 0">
          ...
          >
            ...
            <mat-card-content>
              ...
              <p class="complaint-desc">{{ complaint.description | truncate: 120 }}</p>

              <div class="complaint-meta">
                <span class="meta-item" *ngIf="authService.currentUser?.role !== 'user'">
