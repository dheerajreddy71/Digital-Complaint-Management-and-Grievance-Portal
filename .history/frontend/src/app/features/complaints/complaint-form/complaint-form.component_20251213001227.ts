...
export class ComplaintFormComponent implements OnInit {
	...
	categories = [
		{ value: ComplaintCategory.INFRASTRUCTURE, label: "Infrastructure" },
		{ value: ComplaintCategory.SANITATION, label: "Sanitation" },
		{ value: ComplaintCategory.UTILITIES, label: "Utilities" },
		{ value: ComplaintCategory.PUBLIC_SAFETY, label: "Public Safety" },
		{ value: ComplaintCategory.TRANSPORTATION, label: "Transportation" },
		{ value: ComplaintCategory.ENVIRONMENT, label: "Environment" },
