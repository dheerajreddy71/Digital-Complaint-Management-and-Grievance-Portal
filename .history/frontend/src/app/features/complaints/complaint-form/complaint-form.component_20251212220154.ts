              ...
              <mat-select formControlName="priority">
                <mat-option *ngFor="let pri of priorities" [value]="pri.value">
                  <span class="priority-option">
                    <span class="priority-dot" [class]="'priority-' + pri.value"></span>
                    {{ pri.label }}
                  </span>
                </mat-option>
              </mat-select>
            ...
            <div class="ai-suggestions" *ngIf="suggestions">
              ...
              <div class="suggestion-content">
                ...
                <div class="suggestion-chips">
                  <mat-chip
                    *ngIf="suggestions.suggestedCategory && suggestions.suggestedCategory !== form.get('category')?.value"
                    (click)="applySuggestedCategory()"
                  >
                    Category: {{ suggestions.suggestedCategory | categoryLabel }}
                  </mat-chip>
                  <mat-chip
                    *ngIf="suggestions.suggestedPriority && suggestions.suggestedPriority !== form.get('priority')?.value"
              ...
              <div class="warning-content">
                ...
                <ul>
                  <li *ngFor="let dup of duplicates.slice(0, 3)">
                    <a [routerLink]="['/complaints', dup.id]">{{ dup.title }}</a>
...
export class ComplaintFormComponent implements OnInit {
  ...
  suggestions: { suggestedCategory?: ComplaintCategory; suggestedPriority?: Priority } | null = null;
  duplicates: Complaint[] = [];
  private complaintId: string | null = null;

  categories = [
    { value: ComplaintCategory.SERVICE_DELAY, label: 'Service Delay' },
    { value: ComplaintCategory.STAFF_BEHAVIOR, label: 'Staff Behavior' },
    { value: ComplaintCategory.TECHNICAL_ISSUE, label: 'Technical Issue' },
  ...
  private submitForm(): void {
    ...
    const request$ = this.isEditMode
      ? this.complaintService.updateComplaint(this.complaintId!, this.form.value)
