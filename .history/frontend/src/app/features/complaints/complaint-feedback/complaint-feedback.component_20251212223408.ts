		...
		<mat-card class="feedback-card">
			...
			<mat-card-content>
				...
				<ng-container *ngIf="!isLoading">
					...
					>
						<p class="form-intro">
							Your complaint has been resolved. Please take a moment to rate
							your experience.
						</p>

						<div class="rating-section">
							<label class="section-label"
								>How would you rate our service?</label
							>
							<app-star-rating
							...
							<mat-error
								*ngIf="
									...
									feedbackForm.get('rating')?.hasError('required')
								"
							>
						...
						<mat-form-field appearance="outline" class="full-width">
							...
							<mat-hint align="end"
								>{{
									feedbackForm.get("comments")?.value?.length || 0
								}}/500</mat-hint
							>
						</mat-form-field>
