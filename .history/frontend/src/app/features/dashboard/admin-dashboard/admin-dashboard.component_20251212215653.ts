...
import { AnalyticsData, Complaint, ComplaintStatus, Priority, ComplaintCategory } from '@core/models';
  ...
  template: `
    <div class="dashboard fade-in">
      ...
      <ng-container *ngIf="!isLoading">
        ...
        <div class="stats-grid">
          <mat-card class="stat-card">
            <mat-card-content>
              ...
              <div class="stat-info">
                <span class="stat-value">{{ analytics?.overview?.total_complaints || 0 }}</span>
          ...
          <mat-card class="stat-card">
            <mat-card-content>
              ...
              <div class="stat-info">
                <span class="stat-value">{{ analytics?.overview?.pending_complaints || 0 }}</span>
                <span class="stat-label">Pending</span>
              </div>
            </mat-card-content>
          </mat-card>

          <mat-card class="stat-card warning" *ngIf="(analytics?.overview?.overdue_complaints || 0) > 0">
            <mat-card-content>
              <div class="stat-icon overdue">
                <mat-icon>warning</mat-icon>
              </div>
              <div class="stat-info">
                <span class="stat-value">{{ analytics?.overview?.overdue_complaints || 0 }}</span>
          ...
          <mat-card class="stat-card">
            <mat-card-content>
              ...
              <div class="stat-info">
                <span class="stat-value">{{ (analytics?.overview?.sla_compliance_rate || 0) | number: '1.0-0' }}%</span>
          ...
          <mat-card class="stat-card">
            <mat-card-content>
              ...
              <div class="stat-info">
                <span class="stat-value">{{ analytics?.overview?.resolved_complaints || 0 }}</span>
          ...
          <mat-card class="stat-card">
            <mat-card-content>
              ...
              <div class="stat-info">
                <span class="stat-value">{{ (analytics?.overview?.average_resolution_hours || 0) | number: '1.1-1' }}h</span>
              ...
              <div class="category-breakdown">
                <div
                  *ngFor="let item of analytics?.by_category"
                  class="category-item"
                >
                  <span class="category-name">{{ item.category | categoryLabel }}</span>
        ...
        <!-- Staff Performance -->
        <mat-card class="staff-card" *ngIf="analytics?.staff_performance?.length">
          <mat-card-header>
            <mat-card-title>Staff Performance</mat-card-title>
            <a mat-button color="primary" routerLink="/admin/staff">Manage Staff</a>
          </mat-card-header>
          <mat-card-content>
              ...
              >
                <div class="complaint-main">
                  ...
                  <div class="complaint-meta">
                    ...
                    <span class="meta-item">
                      <mat-icon>schedule</mat-icon>
                      {{ complaint.sla_deadline | slaRemaining: true }}
                    </span>
                  </div>
                </div>
...
export class AdminDashboardComponent implements OnInit {
  ...
  private loadOverdueComplaints(): void {
    this.complaintService.getOverdueComplaints({ limit: 5 }).subscribe({
      next: (response) => {
