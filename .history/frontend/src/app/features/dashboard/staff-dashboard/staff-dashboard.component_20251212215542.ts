    ...
    <div class="dashboard fade-in">
      <div class="page-header">
        <div>
          ...
          <p class="subtitle">Manage assigned complaints and track your workload</p>
        </div>
      ...
      <mat-card class="complaints-card">
        <mat-card-header>
          ...
          <a mat-button color="primary" routerLink="/staff/assigned">View All</a>
        </mat-card-header>
        <mat-card-content>
          ...
          <div class="complaints-list" *ngIf="!isLoading && complaints.length > 0">
            <div
            ...
            >
              <div class="complaint-main">
                ...
                <p class="complaint-desc">{{ complaint.description | truncate: 80 }}</p>
...
export class StaffDashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.isAvailable =
      this.authService.currentUser?.availability_status === AvailabilityStatus.AVAILABLE;
    this.loadComplaints();
  }
  ...
  toggleAvailability(isAvailable: boolean): void {
    const status = isAvailable ? AvailabilityStatus.AVAILABLE : AvailabilityStatus.BUSY;
