          ...
          <mat-card-content>
            ...
            <form [formGroup]="profileForm" (ngSubmit)="updateProfile()" class="profile-form">
              ...
              <div class="form-actions">
                <button mat-raised-button color="primary" type="submit" [disabled]="profileForm.invalid || profileForm.pristine || saving">
                  <mat-spinner *ngIf="saving" diameter="20"></mat-spinner>
                  <mat-icon *ngIf="!saving">save</mat-icon>
                  {{ saving ? 'Saving...' : 'Save Changes' }}
                </button>
                <button mat-stroked-button type="button" (click)="resetForm()" [disabled]="profileForm.pristine">
            ...
            <div class="stats-grid">
              <div class="stat-item">
                ...
                <div class="stat-info">
                  ...
                  <span class="stat-value">{{ user?.created_at | date:'mediumDate' }}</span>
                </div>
              </div>
              ...
              <div class="stat-item">
                ...
                <div class="stat-info">
                  ...
                  <span class="stat-value">{{ user?.last_login | date:'medium' || 'N/A' }}</span>
                </div>
              </div>
              ...
              <div class="stat-item" *ngIf="user?.role === 'staff'">
                ...
                <div class="stat-info">
                  ...
                  <span class="stat-value">{{ stats?.handledComplaints || 0 }}</span>
                </div>
              </div>
              ...
              <div class="stat-item" *ngIf="user?.role === 'staff'">
                ...
                <div class="stat-info">
                  ...
                  <span class="stat-value">{{ stats?.avgRating | number:'1.1-1' || 'N/A' }}</span>
                </div>
              </div>
            </div>
          </mat-card-content>
            ...
            <div class="preference-item">
              <div class="preference-info">
                ...
                <div>
                  ...
                  <span class="preference-desc">Switch between light and dark themes</span>
                </div>
              </div>
            ...
            <div class="preference-item">
              <div class="preference-info">
                ...
                <div>
                  ...
                  <span class="preference-desc">Receive browser notifications</span>
                </div>
              </div>
              <mat-slide-toggle [checked]="pushNotifications" (change)="togglePushNotifications($event.checked)"></mat-slide-toggle>
            </div>
          </mat-card-content>
        </mat-card>
            ...
            <div class="security-item">
              <div class="security-info">
                ...
                <div>
                  ...
                  <span class="security-desc">Last changed {{ passwordLastChanged || 'Never' }}</span>
                </div>
              </div>
            ...
            <div class="security-item">
              <div class="security-info">
                ...
                <div>
                  ...
                  <span class="security-desc">Manage your logged in devices</span>
                </div>
              </div>
              <button mat-stroked-button color="warn" (click)="logoutAllDevices()">
        ...
        <mat-card-content>
          <div class="danger-item">
            <div class="danger-info">
              ...
              <span class="danger-desc">Permanently delete your account and all associated data. This action cannot be undone.</span>
            </div>
...
export class ProfileComponent implements OnInit {
  ...
  toggleEmailNotifications(enabled: boolean): void {
    ...
    this.snackbar.success(`Email notifications ${enabled ? 'enabled' : 'disabled'}`);
  }
  ...
  confirmDeleteAccount(): void {
    ...
    if (confirmed) {
      ...
      if (doubleConfirm === 'DELETE') {
        ...
        this.snackbar.success('Account deletion requested. You will receive a confirmation email.');
      }
    }
  }
}
