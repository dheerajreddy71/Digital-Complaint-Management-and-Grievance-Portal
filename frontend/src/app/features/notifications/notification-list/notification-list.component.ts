					...
					>
						...
						<div class="notification-actions">
							...
							<button
								mat-icon-button
								(click)="
									deleteNotification(notification); $event.stopPropagation()
								"
								matTooltip="Delete"
							>
...
export class NotificationListComponent implements OnInit {
	...
	private iconMap: Record<NotificationType, string> = {
		[NotificationType.COMPLAINT_CREATED]: "add_circle",
		[NotificationType.COMPLAINT_ASSIGNED]: "assignment_ind",
		[NotificationType.STATUS_UPDATED]: "update",
		[NotificationType.COMMENT_ADDED]: "comment",
		[NotificationType.SLA_WARNING]: "schedule",
		[NotificationType.SLA_BREACH]: "warning",
	...
	private iconClassMap: Record<NotificationType, string> = {
		[NotificationType.COMPLAINT_CREATED]: "status",
		[NotificationType.COMPLAINT_ASSIGNED]: "assignment",
		[NotificationType.STATUS_UPDATED]: "status",
		[NotificationType.COMMENT_ADDED]: "comment",
		[NotificationType.SLA_WARNING]: "reminder",
		[NotificationType.SLA_BREACH]: "escalation",
